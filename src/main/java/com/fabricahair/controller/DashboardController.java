...
public class DashboardController {
    ...
    @Autowired private OrdemProducaoRepository opRepository;
    @Autowired private LoteRepository loteRepository;
    @Autowired private PedidoVendaRepository pedidoRepository;
    ...
    public String dashboard(Model model) {
        ...
        model.addAttribute("opAbertas",
            opRepository.findByStatusIn(List.of(
                ...
                com.fabricahair.model.OrdemProducao.StatusOP.EM_PRODUCAO
            )).size());
        ...
        model.addAttribute("ultimosPedidos",
            todosPedidos.size() > 5 ? todosPedidos.subList(todosPedidos.size() - 5, todosPedidos.size()) : todosPedidos);
